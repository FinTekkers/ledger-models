...
public final class ValuationService {
  ...
  /**
   * Protobuf service {@code fintekkers.services.valuation_service.Valuation}
   */
  public static abstract class Valuation
    ...
    public interface Interface {
      /**
       * <code>rpc RunValuation(.fintekkers.requests.valuation.ValuationRequestProto) returns (.fintekkers.requests.valuation.ValuationResponseProto);</code>
       */
    ...
    public static final
        ...
        getDescriptor() {
      return fintekkers.services.valuation_service.ValuationService.getDescriptor().getServices().get(0);
    }
    public final com.google.protobuf.Descriptors.ServiceDescriptor
        getDescriptorForType() {
      return getDescriptor();
    ...
    public final void callMethod(
      ...
      switch(method.getIndex()) {
        case 0:
          this.runValuation(controller, (fintekkers.requests.valuation.ValuationRequestProto)request,
    ...
    public static final class Stub extends fintekkers.services.valuation_service.ValuationService.Valuation implements Interface {
    ...
    private static final class BlockingStub implements BlockingInterface {
      ...
      public fintekkers.requests.valuation.ValuationResponseProto runValuation(
          ...
          fintekkers.requests.valuation.ValuationRequestProto request)
          throws com.google.protobuf.ServiceException {
        return (fintekkers.requests.valuation.ValuationResponseProto) channel.callBlockingMethod(
          getDescriptor().getMethods().get(0),
          controller,
          request,
          fintekkers.requests.valuation.ValuationResponseProto.getDefaultInstance());
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "valuation_service.proto\022%fintekkers.serv" +
