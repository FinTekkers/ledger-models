...
/**
 * Protobuf type {@code fintekkers.models.strategy.StrategyAllocationProto}
 */
public final class StrategyAllocationProto extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:fintekkers.models.strategy.StrategyAllocationProto)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return fintekkers.models.strategy.StrategyAllocationProtos.internal_static_fintekkers_models_strategy_StrategyAllocationProto_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return fintekkers.models.strategy.StrategyAllocationProtos.internal_static_fintekkers_models_strategy_StrategyAllocationProto_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            fintekkers.models.strategy.StrategyAllocationProto.class, fintekkers.models.strategy.StrategyAllocationProto.Builder.class);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<fintekkers.models.strategy.MapFieldEntry> allocations_;
  /**
   * <pre>
   *Map
   * </pre>
   ...
   */
  @java.lang.Override
  public java.util.List<fintekkers.models.strategy.MapFieldEntry> getAllocationsList() {
    return allocations_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<? extends fintekkers.models.strategy.MapFieldEntryOrBuilder> 
   ...
   */
  @java.lang.Override
  public fintekkers.models.strategy.MapFieldEntry getAllocations(int index) {
   ...
   */
  @java.lang.Override
  public fintekkers.models.strategy.MapFieldEntryOrBuilder getAllocationsOrBuilder(
      int index) {
    return allocations_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof fintekkers.models.strategy.StrategyAllocationProto)) {
      return super.equals(obj);
    }
    fintekkers.models.strategy.StrategyAllocationProto other = (fintekkers.models.strategy.StrategyAllocationProto) obj;
  ...
  public static fintekkers.models.strategy.StrategyAllocationProto parseFrom(
  ...
  public static fintekkers.models.strategy.StrategyAllocationProto parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static fintekkers.models.strategy.StrategyAllocationProto parseFrom(
  ...
  public static fintekkers.models.strategy.StrategyAllocationProto parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static fintekkers.models.strategy.StrategyAllocationProto parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static fintekkers.models.strategy.StrategyAllocationProto parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(fintekkers.models.strategy.StrategyAllocationProto prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:fintekkers.models.strategy.StrategyAllocationProto)
      fintekkers.models.strategy.StrategyAllocationProtoOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return fintekkers.models.strategy.StrategyAllocationProtos.internal_static_fintekkers_models_strategy_StrategyAllocationProto_descriptor;
    }
    ...
    // Construct using fintekkers.models.strategy.StrategyAllocationProto.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public fintekkers.models.strategy.StrategyAllocationProto getDefaultInstanceForType() {
      return fintekkers.models.strategy.StrategyAllocationProto.getDefaultInstance();
    }

    @java.lang.Override
    public fintekkers.models.strategy.StrategyAllocationProto build() {
      fintekkers.models.strategy.StrategyAllocationProto result = buildPartial();
    ...
    @java.lang.Override
    public fintekkers.models.strategy.StrategyAllocationProto buildPartial() {
      fintekkers.models.strategy.StrategyAllocationProto result = new fintekkers.models.strategy.StrategyAllocationProto(this);
    ...
    private void buildPartialRepeatedFields(fintekkers.models.strategy.StrategyAllocationProto result) {
      if (allocationsBuilder_ == null) {
    ...
    private void buildPartial0(fintekkers.models.strategy.StrategyAllocationProto result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof fintekkers.models.strategy.StrategyAllocationProto) {
        return mergeFrom((fintekkers.models.strategy.StrategyAllocationProto)other);
      } else {
    ...
    public Builder mergeFrom(fintekkers.models.strategy.StrategyAllocationProto other) {
      if (other == fintekkers.models.strategy.StrategyAllocationProto.getDefaultInstance()) return this;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 82: {
              fintekkers.models.strategy.MapFieldEntry m =
                  input.readMessage(
                      fintekkers.models.strategy.MapFieldEntry.parser(),
                      extensionRegistry);
              if (allocationsBuilder_ == null) {
                ensureAllocationsIsMutable();
                allocations_.add(m);
    ...
    private void ensureAllocationsIsMutable() {
      if (!((bitField0_ & 0x00000020) != 0)) {
        allocations_ = new java.util.ArrayList<fintekkers.models.strategy.MapFieldEntry>(allocations_);
        bitField0_ |= 0x00000020;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        fintekkers.models.strategy.MapFieldEntry, fintekkers.models.strategy.MapFieldEntry.Builder, fintekkers.models.strategy.MapFieldEntryOrBuilder> allocationsBuilder_;
    ...
    public Builder setAllocations(
        int index, fintekkers.models.strategy.MapFieldEntry value) {
      if (allocationsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setAllocations(
        int index, fintekkers.models.strategy.MapFieldEntry.Builder builderForValue) {
      if (allocationsBuilder_ == null) {
        ensureAllocationsIsMutable();
     ...
     * <code>repeated .fintekkers.models.strategy.MapFieldEntry allocations = 10;</code>
     */
    public Builder addAllocations(fintekkers.models.strategy.MapFieldEntry value) {
      if (allocationsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addAllocations(
        fintekkers.models.strategy.MapFieldEntry.Builder builderForValue) {
      if (allocationsBuilder_ == null) {
        ensureAllocationsIsMutable();
    ...
    public Builder addAllAllocations(
        java.lang.Iterable<? extends fintekkers.models.strategy.MapFieldEntry> values) {
      if (allocationsBuilder_ == null) {
        ensureAllocationsIsMutable();
     ...
     * <code>repeated .fintekkers.models.strategy.MapFieldEntry allocations = 10;</code>
     */
    public fintekkers.models.strategy.MapFieldEntry.Builder getAllocationsBuilder(
        int index) {
     ...
     * <code>repeated .fintekkers.models.strategy.MapFieldEntry allocations = 10;</code>
     */
    public fintekkers.models.strategy.MapFieldEntry.Builder addAllocationsBuilder() {
      return getAllocationsFieldBuilder().addBuilder(
          fintekkers.models.strategy.MapFieldEntry.getDefaultInstance());
    }
    /**
     * <pre>
     *Map
    ...
    public fintekkers.models.strategy.MapFieldEntry.Builder addAllocationsBuilder(
        int index) {
      return getAllocationsFieldBuilder().addBuilder(
          index, fintekkers.models.strategy.MapFieldEntry.getDefaultInstance());
    }
    /**
     * <pre>
     *Map
     ...
     * <code>repeated .fintekkers.models.strategy.MapFieldEntry allocations = 10;</code>
     */
    public java.util.List<fintekkers.models.strategy.MapFieldEntry.Builder> 
         getAllocationsBuilderList() {
      return getAllocationsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        fintekkers.models.strategy.MapFieldEntry, fintekkers.models.strategy.MapFieldEntry.Builder, fintekkers.models.strategy.MapFieldEntryOrBuilder> 
    ...
    // @@protoc_insertion_point(builder_scope:fintekkers.models.strategy.StrategyAllocationProto)
  }

  // @@protoc_insertion_point(class_scope:fintekkers.models.strategy.StrategyAllocationProto)
  private static final fintekkers.models.strategy.StrategyAllocationProto DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new fintekkers.models.strategy.StrategyAllocationProto();
  }

  public static fintekkers.models.strategy.StrategyAllocationProto getDefaultInstance() {
