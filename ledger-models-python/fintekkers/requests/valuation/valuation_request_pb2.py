...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_VALUATIONREQUESTPROTO']._serialized_start=386
  _globals['_VALUATIONREQUESTPROTO']._serialized_end=907
