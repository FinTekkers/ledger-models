...
class ValuationRequestProto(_message.Message):
    __slots__ = ("object_class", "version", "operation_type", "measures", "security_input", "position_input", "price_input", "asof_datetime", "cpi_price_input")
