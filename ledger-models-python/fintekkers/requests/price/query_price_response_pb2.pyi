...
class QueryPriceResponseProto(_message.Message):
    __slots__ = ("object_class", "version", "query_price_request", "price_response", "errors_or_warnings")
    ...
    def __init__(self, object_class: _Optional[str] = ..., version: _Optional[str] = ..., query_price_request: _Optional[_Union[_query_price_request_pb2.QueryPriceRequestProto, _Mapping]] = ..., price_response: _Optional[_Iterable[_Union[_price_pb2.PriceProto, _Mapping]]] = ..., errors_or_warnings: _Optional[_Union[_summary_pb2.SummaryProto, _Mapping]] = ...) -> None: ...
