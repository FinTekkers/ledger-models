...
class QuerySecurityRequestProto(_message.Message):
    __slots__ = ("object_class", "version", "uuIds", "search_security_input", "as_of", "name_filter")
    ...
    name_filter: str
    def __init__(self, object_class: _Optional[str] = ..., version: _Optional[str] = ..., uuIds: _Optional[_Iterable[_Union[_uuid_pb2.UUIDProto, _Mapping]]] = ..., search_security_input: _Optional[_Union[_position_filter_pb2.PositionFilterProto, _Mapping]] = ..., as_of: _Optional[_Union[_local_timestamp_pb2.LocalTimestampProto, _Mapping]] = ..., name_filter: _Optional[str] = ...) -> None: ...
