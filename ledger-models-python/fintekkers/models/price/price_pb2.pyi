...
from fintekkers.models.price import price_type_pb2 as _price_type_pb2
...
class PriceProto(_message.Message):
    __slots__ = ("object_class", "version", "uuid", "as_of", "is_link", "valid_from", "valid_to", "price", "security", "price_type")
