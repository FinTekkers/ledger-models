...
proto.fintekkers.requests.price.QueryPriceResponseProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 20:
      var value = new fintekkers_requests_price_query_price_request_pb.QueryPriceRequestProto;
      reader.readMessage(value,fintekkers_requests_price_query_price_request_pb.QueryPriceRequestProto.deserializeBinaryFromReader);
...
proto.fintekkers.requests.price.QueryPriceResponseProto.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      20,
      f,
      fintekkers_requests_price_query_price_request_pb.QueryPriceRequestProto.serializeBinaryToWriter
    );
  }
...
proto.fintekkers.requests.price.QueryPriceResponseProto.prototype.getQueryPriceRequest = function() {
  return /** @type{?proto.fintekkers.requests.price.QueryPriceRequestProto} */ (
    jspb.Message.getWrapperField(this, fintekkers_requests_price_query_price_request_pb.QueryPriceRequestProto, 20));
};
