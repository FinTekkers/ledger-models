...
var fintekkers_models_price_price_type_pb = require('../../../fintekkers/models/price/price_type_pb.js');
goog.object.extend(proto, fintekkers_models_price_price_type_pb);
...
proto.fintekkers.models.price.PriceProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 11:
      ...
      break;
    case 12:
      var value = /** @type {!proto.fintekkers.models.price.PriceTypeProto} */ (reader.readEnum());
...
/**
 * optional PriceTypeProto price_type = 12;
 * @return {!proto.fintekkers.models.price.PriceTypeProto}
 */
proto.fintekkers.models.price.PriceProto.prototype.getPriceType = function() {
  return /** @type {!proto.fintekkers.models.price.PriceTypeProto} */ (jspb.Message.getFieldWithDefault(this, 12, 0));
};


/**
 * @param {!proto.fintekkers.models.price.PriceTypeProto} value
 * @return {!proto.fintekkers.models.price.PriceProto} returns this
 */
proto.fintekkers.models.price.PriceProto.prototype.setPriceType = function(value) {
