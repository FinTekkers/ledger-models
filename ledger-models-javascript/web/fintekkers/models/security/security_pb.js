...
proto.fintekkers.models.security.SecurityProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    identifier: (f = msg.getIdentifier()) && proto.fintekkers.models.security.IdentifierProto.toObject(includeInstance, f),
    description: jspb.Message.getFieldWithDefault(msg, 41, ""),
    cashId: jspb.Message.getFieldWithDefault(msg, 50, ""),
    couponRate: (f = msg.getCouponRate()) && proto.fintekkers.models.util.DecimalValueProto.toObject(includeInstance, f),
    couponType: jspb.Message.getFieldWithDefault(msg, 61, 0),
    couponFrequency: jspb.Message.getFieldWithDefault(msg, 62, 0),
    datedDate: (f = msg.getDatedDate()) && proto.fintekkers.models.util.LocalDateProto.toObject(includeInstance, f),
    faceValue: (f = msg.getFaceValue()) && proto.fintekkers.models.util.DecimalValueProto.toObject(includeInstance, f),
    issueDate: (f = msg.getIssueDate()) && proto.fintekkers.models.util.LocalDateProto.toObject(includeInstance, f),
    maturityDate: (f = msg.getMaturityDate()) && proto.fintekkers.models.util.LocalDateProto.toObject(includeInstance, f),
    issuanceInfoList: jspb.Message.toObjectList(msg.getIssuanceInfoList(),
    proto.fintekkers.models.security.bond.IssuanceProto.toObject, includeInstance)
  };
...
proto.fintekkers.models.security.SecurityProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 14:
      ...
      break;
    case 40:
      var value = new proto.fintekkers.models.security.IdentifierProto;
      reader.readMessage(value,proto.fintekkers.models.security.IdentifierProto.deserializeBinaryFromReader);
    ...
    case 66:
      ...
      break;
    case 67:
      var value = new proto.fintekkers.models.security.bond.IssuanceProto;
      reader.readMessage(value,proto.fintekkers.models.security.bond.IssuanceProto.deserializeBinaryFromReader);
...
proto.fintekkers.models.security.SecurityProto.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      40,
      f,
      proto.fintekkers.models.security.IdentifierProto.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      67,
      f,
      proto.fintekkers.models.security.bond.IssuanceProto.serializeBinaryToWriter
    );
  }
};
...
proto.fintekkers.models.security.SecurityProto.prototype.getIdentifier = function() {
  return /** @type{?proto.fintekkers.models.security.IdentifierProto} */ (
    jspb.Message.getWrapperField(this, proto.fintekkers.models.security.IdentifierProto, 40));
};
...
proto.fintekkers.models.security.SecurityProto.prototype.getCouponRate = function() {
  return /** @type{?proto.fintekkers.models.util.DecimalValueProto} */ (
    jspb.Message.getWrapperField(this, proto.fintekkers.models.util.DecimalValueProto, 60));
};
...
proto.fintekkers.models.security.SecurityProto.prototype.getDatedDate = function() {
  return /** @type{?proto.fintekkers.models.util.LocalDateProto} */ (
    jspb.Message.getWrapperField(this, proto.fintekkers.models.util.LocalDateProto, 63));
};
...
proto.fintekkers.models.security.SecurityProto.prototype.getFaceValue = function() {
  return /** @type{?proto.fintekkers.models.util.DecimalValueProto} */ (
    jspb.Message.getWrapperField(this, proto.fintekkers.models.util.DecimalValueProto, 64));
};
...
proto.fintekkers.models.security.SecurityProto.prototype.getIssueDate = function() {
  return /** @type{?proto.fintekkers.models.util.LocalDateProto} */ (
    jspb.Message.getWrapperField(this, proto.fintekkers.models.util.LocalDateProto, 65));
};
...
proto.fintekkers.models.security.SecurityProto.prototype.getMaturityDate = function() {
  return /** @type{?proto.fintekkers.models.util.LocalDateProto} */ (
    jspb.Message.getWrapperField(this, proto.fintekkers.models.util.LocalDateProto, 66));
};
...
proto.fintekkers.models.security.SecurityProto.prototype.getIssuanceInfoList = function() {
  return /** @type{!Array<!proto.fintekkers.models.security.bond.IssuanceProto>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.fintekkers.models.security.bond.IssuanceProto, 67));
};
